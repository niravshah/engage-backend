...
module.exports = function(app,bcrypt) {
    app.post('/setup/project', function (req, res) {
        ...
        Misc.find({type:"skill",tid:"localhost"},function(err,skills){
    ...
    app.post("/setup/skills",function(req,res){
